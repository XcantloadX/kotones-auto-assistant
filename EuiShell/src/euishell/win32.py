...
# 与 Shell TitleBar.qml 匹配的标题栏几何参数
...
class TabBarHitTestBridge(QObject):
    ...
    def _get_tab_interactive_end(self) -> int:
        return self._tab_interactive_end

    def _set_tab_interactive_end(self, value: int) -> None:
        self._tab_interactive_end = value

    tabInteractiveEnd = Property(int, _get_tab_interactive_end, _set_tab_interactive_end)
...
class WindowStateBridge(QObject):
    ...
    def minimize(self) -> None:
        ...
        states &= ~Qt.WindowState.WindowActive
        self._window.setWindowStates(states | Qt.WindowState.WindowMinimized)
...
class WindowEventFilter(QAbstractNativeEventFilter):
    ...
    def _hit_test(self, msg: _MSG) -> tuple[bool, int]:
        ...
        if not is_max:
            ...
            if top_e and right_e:
                return True, HTTOPRIGHT
            if bottom_e and left_e:
                return True, HTBOTTOMLEFT
            if bottom_e and right_e:
